...
@Component({
  ...
  templateUrl: './entidadesFinancieras-list.component.html',
  styleUrls: ['./entidadesFinancieras-list.component.css']
})
export class EntidadesFinancierasListComponent implements OnInit {
  ...
  delete(entidadFinanciera: EntidadFinancieraModel): void {
    swal.fire({
      title: 'Está seguro?',
