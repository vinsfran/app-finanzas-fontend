...
@Component({
  selector: 'app-clientes-form-new',
  templateUrl: './clientes-form-new.component.html',
  styleUrls: ['./clientes-form-new.component.css']
})
export class ClientesFormNewComponent implements OnInit {
  titulo: string;
  lista: string[];
